...
<table cellpadding="10" cellspacing="0" border="0" width="85%"  align="center" >
    ...
    <td colspan="5" align="center"><font size="4"><b>Conte&uacute;dos</b></font></td>
	</tr>
	...
	<tr>	
		...
		if (empty($_SESSION["FILTRO"]))
			$_SESSION["FILTRO"] = "instanciaAtual";

		?>	
			<td colspan="3" align="left">
				<a href="apoio_operacao.php?PAGINA=<?=$_REQUEST['PAGINA']?>&OPCAO=Inserir">Inserir novo Conte&uacute;do</a>				
			</td>
		...
		?>
			<td colspan="1" align="left">
				<a href="apoio_operacao.php?OPCAO=Inserir">Inserir novo Conte&uacute;do</a>				
			</td>
	...
	<tr>
		...
		if ($acesso == 1)
		{
			...
			<td align="center"><a href="?FILTRO=suas">Seus Conte&uacute;dos</a></td>	
...
{		
		...
		$rsConN = listaApoioAdm($_SESSION["codInstanciaGlobal"], $filtro, $quem);		
      ...
      <tr> <td colspan="3"><p><font color=red>AVISO: Ao retirar o Conte&uacute;do neste local, o arquivo não mais existirá .</font></p>  </td> </tr>
      <?php
      ...
      while ($linhaN) {
        ...
        if ( 
        	...
        	echo "		<a href=\"#\" onClick=\"if (confirm('Deseja mesmo excluir este arquivo ?')) { window.open('apoio_envio.php?PAGINA=".$_REQUEST['PAGINA']."&OPCAO=Remover&COD_ARQUIVO=" . $linhaN["COD_ARQUIVO"] . "','Wlocal','top=106,left=160,width=300px,height=200px,toolbar=no,status=yes,menubar=no,scrollbars=yes,scrolling=yes,resizable=yes') }\">\n".
        		 "			<img src=\"../imagens/remove.gif\" border=0 alt=\"Remover\">\n".
        		 "		</a>\n&nbsp;&nbsp;&nbsp;\n".
        		 "		<a href=\"apoio_operacao.php?PAGINA=".$_REQUEST['PAGINA']."&OPCAO=Alterar&COD_ARQUIVO=".$linhaN["COD_ARQUIVO"]."\">\n".
        ...
        echo "  &nbsp;&nbsp;&nbsp; <b> Não há arquivos cadastradas. </b>";
      }
    }
