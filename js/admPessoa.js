...
function validaNovaPessoa(){
  ...
  if ((document.form.vinculoUfrgs.value == "0"))
  {
	...
	else if ((document.form.vinculoUfrgs.value == "1") || (document.form.vinculoUfrgs.value == "") || (document.form.vinculoUfrgs.value == null))
	{
  	if ((document.form.cartaoUfrgs.value == null) || (document.form.cartaoUfrgs.value == ""))
  	{
  		msg += "-> Preencher o cartão UFRGS;\n";
  		erro = true;
  	}
  }
	//valida emailPessoa
