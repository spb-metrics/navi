...
function AMnoMathMLNote() {
  var nd = AMcreateElementXHTML("p");
  nd.setAttribute("align","center");
  //nd.appendChild(AMcreateElementXHTML("p"));
  nd.appendChild(document.createTextNode("Para ver a notação ASCIIMathML "));
 // var an = AMcreateElementXHTML("a");
 // an.appendChild(document.createTextNode("ASCIIMathML"));
  //an.setAttribute("href","http://www.chapman.edu/~jipsen/asciimath.html");
 // nd.appendChild(an);
  nd.appendChild(document.createTextNode(" use Internet Explorer 6+ "));  
  var an = AMcreateElementXHTML("a");
  an.appendChild(document.createTextNode("MathPlayer"));
  an.setAttribute("href","http://www.dessci.com/en/products/mathplayer/download.htm");
  nd.appendChild(an);
  nd.appendChild(document.createTextNode(" ou Netscape/Mozilla/Firefox"));
  nd.appendChild(AMcreateElementXHTML("p"));
  nd.appendChild(AMcreateElementXHTML("p"));
  an = AMcreateElementXHTML("a");
  an.appendChild(document.createTextNode("Não desejo instalar neste momento."));
  an.setAttribute("href","./forum.php?unSetMathml=1");
  nd.appendChild(an);  
  nd.appendChild(AMcreateElementXHTML("p"));
  return nd;
}
