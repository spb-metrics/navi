...
function enquete($cod_enquete, $cod_resposta, $opcao)
{
  ...
  if ($cod_enquete == "")
    {
      $strSQL = "SELECT E.COD_ENQUETE, E.TEXTO_ENQUETE FROM enquete E, enquete_instancia ET".
      ...
      if ($opcao == 0)
	{
	  ...
	  $strSQL = "SELECT E.TEXTO_ENQUETE, ER.COD_RESPOSTA, ER.TEXTO_RESPOSTA FROM enquete E, enquete_resposta ER, enquete_instancia ET".
      ...
      else
	{
	  if ($opcao == 1)
		...
		" WHERE E.COD_ENQUETE = ER.COD_ENQUETE AND ER.COD_ENQUETE = ET.COD_ENQUETE AND ET.COD_ENQUETE= " . $cod_enquete . " AND ET.COD_INSTANCIA_GLOBAL = '" . $_SESSION["codInstanciaGlobal"] . "' AND ET.COD_ENQUETE_INSTANCIA = EAV.COD_ENQUETE_TURMA AND ER.COD_RESPOSTA = EAV.COD_RESPOSTA";
