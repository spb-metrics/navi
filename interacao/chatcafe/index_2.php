...
<?php
if ( ( $_SESSION["COD_PESSOA"] == "" ) OR ( $_SESSION["COD_TURMA"] == "" ) )
	exit();
?>
...
if ( !isset($_REQUEST["COM_VIDEO"]) )
	...
	if ( $_REQUEST["COM_VIDEO"] != "" )
	{
		...
		echo "<object width='120' height='90'  id=\"Video Aula\" classid=\"CLSID:22D6F312-B0F6-11D0-94AB-0080C74C7E95\"";
...
?>
   ...
   <iframe id="framechat" frameborder=0 src="./chat.php?NOME=<?=$_SESSION["NOME_PESSOA"];?>&ROOM=<?=$_SESSION["COD_TURMA"];?>" style="width:100%; height:435px; z-index:1; border:1px solid  #000000;"></iframe> 
	 </td>
