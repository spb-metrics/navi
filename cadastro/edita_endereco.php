...
<form name="form" id="form" method="post" action="edita_endereco_proc.php">
<table id="endereco" align="center">	
<tr>
	<td colspan="<? print $colSpan; ?>" class="tituloEndereco" id="tipohtml">
		<b>Editar Endere&ccedil;os <? print $linhaEnd["DESC_TIPO_END"]; ?></b>
	</td>
</tr>
<tr>
	<td valign="top">
	...
	<td>
		<?
			...
			print "<select  onChange='mudaTipo()' name='tipo_endereco'>";
			while($linhaTipoEndereco = mysql_fetch_array($tpEnd)){
					if($linhaTipoEndereco["COD_TIPO_END"] == $linhaEnd["COD_TIPO_END"])
						$selected	="selected";
					else
						$selected	=""; 
...
<tr>
	...
	<td>
		<input type="text" name="descricao" size="50" id="descricao" <? if( ltrim(rtrim($linhaEnd["DESC_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["DESC_END"]))."'"; else print "value=''";?>/>
	</td>
</tr>
<tr>	
	<td>
	...
	<td>
		<input type="text" name="bairro" id="bairro" <? if( ltrim(rtrim($linhaEnd["BAIRRO_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["BAIRRO_END"]))."'"; else print "value=''";?>/>
	</td>
</tr>
...
<tr>	
	...
	<td>
		<input type="text" name="cidade" id="cidade" <? if( ltrim(rtrim($linhaEnd["CIDADE_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["CIDADE_END"]))."'"; else print "value=''";?>/>
	</td>
</tr>
...
<tr>	
	...
	<td>
		<input type="text" name="uf" id="uf" <? if( ltrim(rtrim($linhaEnd["UF_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["UF_END"]))."'"; else print "value=''";?>/>
	</td>
</tr>
...
<tr>	
	...
	<td>
		<input type="text" name="pais" id="pais" <? if( ltrim(rtrim($linhaEnd["PAIS_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["PAIS_END"]))."'"; else print "value=''";?> size="2" maxlength="2"/>
	</td>
</tr>
...
<tr>	
	...
	<td>
		<input type="text" name="cep" id="cep" <? if( ltrim(rtrim($linhaEnd["CEP_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["CEP_END"]))."'"; else print "value=''";?>/>
	</td>
</tr>
	...
	<tr id="profissional1" style="visibility:hidden;">	
		...
		<td>
			<input type="text" name="empresa" id="empresa" <? if( ltrim(rtrim($linhaEnd["EMPRESA_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["EMPRESA_END"]))."'"; else print "value=''";?>/>
		</td>
	</tr>
	<tr id="profissional2" style="visibility:hidden;">
		...
		<td>
			<input type="text" name="setor" id="setor" <? if( ltrim(rtrim($linhaEnd["SETOR_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["SETOR_END"]))."'"; else print "value=''";?>/>
		</td>
	</tr>
	<tr id="profissional3" style="visibility:hidden;">
		...
		<td>
			<input type="text" name="cargo" id="cargo" <? if( ltrim(rtrim($linhaEnd["CARGO_END"])) != "") print "value='".ltrim(rtrim($linhaEnd["CARGO_END"]))."'"; else print "value=''";?>/>
		</td>
	</tr>
	...
	<tr>
		<td colspan="<? print $colSpan; ?>" class="tdBranca" align="center">
			...
			<input type="hidden" name="cod_endereco" id="cod_endereco" value="<? print $codigoEndereco; ?>"/>
